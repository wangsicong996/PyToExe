...
def crear_interfaz():
    ...
    tk.Label(ventana, text="Nombre de la m�quina:").grid(row=0, column=0, pady=5, padx=10, sticky="w")
    ...
    tk.Button(frame_botones, text="�ltimo log", command=accion_buscar_1).pack(side="left", padx=10)
    tk.Button(frame_botones, text="�ltimos 5 logs", command=accion_buscar_5).pack(side="left", padx=10)
