...
def getch():
    """Получает один символ без ожидания Enter, кросс-платформенная реализация."""
...
def get_input(prompt):
    """Функция для ввода с обработкой Escape и Backspace."""
    ...
    while True:
        ...
        if ch == '\x1b':  # Escape
            ...
            if input_str:
                ...
                print('\b \b', end='', flush=True)  # Стереть символ
        else:
            input_str += ch
...
def get_yes_no_input(prompt):
    ...
    if response == '' or response.lower() in ['1', 'да', 'yes', 'y', 'д']:
        ...
        return get_yes_no_input(prompt)  # Рекурсивно повторить
